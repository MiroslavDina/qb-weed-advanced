...
Shared.WaterItem = 'water_canister'
...
Shared.PackedItems = {
    WHITE_WIDOW = 'white_widow_weedplant_packedweed',
    SKUNK = 'skunk_weedplant_packedweed',
    PURPLE_HAZE = 'purple_haze_weedplant_packedweed',
    OG_KUSH = 'og_kush_weedplant_packedweed',
    AMNESIA = 'amnesia_weedplant_packedweed',
    AK_47 = 'ak47_weedplant_packedweed',
    INSOMNIA = 'weedplant_packedweed'
}
Shared.PackedWeedItems = {
    ["weedplant_packedweed"] = {
        type = Shared.PackedItems.INSOMNIA,
    },
    ["white_widow_weedplant_packedweed"] = {
        type = Shared.PackedItems.WHITE_WIDOW,
    },
    ["skunk_weedplant_packedweed"] = {
        type = Shared.PackedItems.SKUNK,
    },
    ["purple_haze_weedplant_packedweed"] = {
        type = Shared.PackedItems.PURPLE_HAZE,
    },
    ["og_kush_weedplant_packedweed"] = {
        type = Shared.PackedItems.OG_KUSH,
    },
    ["amnesia_weedplant_packedweed"] = {
        type = Shared.PackedItems.AMNESIA,
    },
    ["ak47_weedplant_packedweed"] = {
        type = Shared.PackedItems.AK_47,
    }
}
Shared.GearItems = {
    TRIMMING_SCISSORS = 'trimming_scissors',
    EMPTY_WEED_BAG = 'empty_weed_bag'
}
Shared.AccessoriesItems = {
    ["trimming_scissors"] = {
        type = Shared.GearItems.TRIMMING_SCISSORS,
    },
    ["empty_weed_bag"] = {
        type = Shared.GearItems.EMPTY_WEED_BAG,
    }
}
Shared.WeedTypes = {
...
Shared.SeedItems = {
    ["weedplant_seedf"] = {
        type = Shared.WeedTypes.INSOMNIA,
        rewardItem = 'weedplant_branch',
    },
    ["white_widow_seed"] = {
        type = Shared.WeedTypes.WHITE_WIDOW,
        rewardItem = 'white_widow_branch',
    },
    ["skunk_seed"] = {
        type = Shared.WeedTypes.SKUNK,
        rewardItem = 'skunk_branch',
    },
    ["purple_haze_seed"] = {
        type = Shared.WeedTypes.PURPLE_HAZE,
        rewardItem = 'purple_haze_branch',
    },
    ["og_kush_seed"] = {
        type = Shared.WeedTypes.OG_KUSH,
        rewardItem = 'og_kush_branch',
    },
    ["amnesia_seed"] = {
        type = Shared.WeedTypes.AMNESIA,
        rewardItem = 'amnesia_branch',
    },
    ["ak47_seed"] = {
        type = Shared.WeedTypes.AK_47,
        rewardItem = 'ak47_branch',
    }
}
Shared.WeedBranchItems = {
    ["weedplant_branch"] = {
        type = Shared.WeedTypes.INSOMNIA,
        rewardItem = 'weedplant_weed',
    },
    ["white_widow_branch"] = {
        type = Shared.WeedTypes.WHITE_WIDOW,
        rewardItem = 'white_widow_weed',
    },
    ["skunk_branch"] = {
        type = Shared.WeedTypes.SKUNK,
        rewardItem = 'skunk_weed',
    },
    ["purple_haze_branch"] = {
        type = Shared.WeedTypes.PURPLE_HAZE,
        rewardItem = 'purple_haze_weed',
    },
    ["og_kush_branch"] = {
        type = Shared.WeedTypes.OG_KUSH,
        rewardItem = 'og_kush_weed',
    },
    ["amnesia_branch"] = {
        type = Shared.WeedTypes.AMNESIA,
        rewardItem = 'amnesia_weed',
    },
    ["ak47_branch"] = {
        type = Shared.WeedTypes.AK_47,
        rewardItem = 'ak47_weed',
    }
}
Shared.WeedItems = {
    ["weedplant_weed"] = {
        type = Shared.WeedTypes.INSOMNIA,
        rewardItem = 'weedplant_packedweed',
    },
    ["white_widow_weed"] = {
        type = Shared.WeedTypes.WHITE_WIDOW,
        rewardItem = 'white_widow_weedplant_packedweed',
    },
    ["skunk_weed"] = {
        type = Shared.WeedTypes.SKUNK,
        rewardItem = 'skunk_weedplant_packedweed',
    },
    ["purple_haze_weed"] = {
        type = Shared.WeedTypes.PURPLE_HAZE,
        rewardItem = 'purple_haze_weedplant_packedweed',
    },
    ["og_kush_weed"] = {
        type = Shared.WeedTypes.OG_KUSH,
        rewardItem = 'og_kush_weedplant_packedweed',
    },
    ["amnesia_weed"] = {
        type = Shared.WeedTypes.AMNESIA,
        rewardItem = 'amnesia_weedplant_packedweed',
    },
    ["ak47_weed"] = {
        type = Shared.WeedTypes.AK_47,
        rewardItem = 'ak47_weedplant_packedweed',
    }
}
...
Shared.WeedLab = {
    ...
    RequireKey = false, --true,  -- Set this to false to disable the requirement of a lab key to enter the weed lab (set to true if you want to use the key)
    EnableSound = true, --  Set this to false if you dont want the interact sound while exiting / entering the wee lab.
}

Shared.ProcessingHealthFallback = 20 -- fallback if item.info.health is nil                                  -----------------zmenene z 25
...
Shared.GrowTime = 60 --180 -- Time in minutes for a plant to grow from 0 to 100                                                   -----------------zmenene
...
Shared.PackageAmount = 20 -- Amount of Shared.WeedItems required to create a package                                      -----------------zmenene
Shared.DeliveryPackageAmount = 20 -- Amount of Shared.PackedWeedItems required to create a box package
Shared.PackageTime = 0.5 --1 --2 -- Time in minutes to wait for packaging                                                           -----------------zmenene
